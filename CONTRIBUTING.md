...
```
cd existing_repo
git remote add origin https://gitlab.intapp.com/Products/sre/sql-metabase.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.intapp.com/Products/sre/sql-metabase/-/settings/integrations)
